<template>
  <div class="full-calendar-body">
    ...
    <div class="dates" ref="dates">
      <div class="dates-bg">
        <div class="week-row" v-for="(week,index) in currentDates" :key="index" :style="{height:height+'px'}">
          <div
            class="day-cell"
...
export default {
  ...
  created() {
    ...
    // this.events = events
    this.height = (document.body.clientHeight - 327) / 6
  },
  data() {
    return {
      // weekNames : DAY_NAMES,
