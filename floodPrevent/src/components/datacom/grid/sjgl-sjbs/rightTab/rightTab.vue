...
export default {
  data() {
    return {
      table_header: [
        ...
        { labelname: '诞生时间', propname: 'DSSJ' },
        { labelname: '消亡时间', propname: 'XWSJ' },
        { labelname: '是否消亡', propname: 'SFXW' },
        { labelname: '标准编码', propname: 'BZBM' },
        { labelname: '普查编码', propname: 'PCBM' },
        { labelname: '时间戳', propname: 'SJC' },
        { labelname: '数据来源', propname: 'SJLY' },
        { labelname: '备注', propname: 'BZ' },
        { labelname: '创建时间', propname: 'CJSJ' },
        { labelname: '最后更新时间', propname: 'ZHGXSJ' }
      ],
      currentPage: 1,
      pagePize: 15,
      tableData: [],
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_sjbs', this.result, param)
    },
    searchSubmit(data) {
      this.load(data)
    },
