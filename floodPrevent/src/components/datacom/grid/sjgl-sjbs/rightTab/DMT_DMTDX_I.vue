<template>
  <div>
    ...
    <div class="gr-datagrid">
      <div class="gr-tag">
        <span class="data-title">多媒体标识</span>
...
<script>
import search from '@/components/datacom/search/sjgl-sjbs/DMT_DMTDX_I.vue'
...
export default {
  data() {
    return {
      table_header: [
        { labelname: '多媒体对象ID', propname: 'DXID' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_sjbs__DMT_DMTDX_I', this.result, param)
    },
    searchSubmit(data) {
      this.load(data)
    },
    ...
    seeYjcl(data) {
      ...
      this.dialogContentComponent = () => import('@/components/datacom/dialog/sjgl-sjbs/DMT_DMTDX_I.vue')
    },
    seeYjclAdd() {
