<template>
  <div>
    ...
    <div class="gr-datagrid">
      <div class="gr-tag">
        <span class="data-title">监控点标识</span>
...
<script>
import search from '@/components/datacom/search/sjgl-sjbs/JKD_JKDDX_I.vue'
...
export default {
  data() {
    return {
      table_header: [
        { labelname: '监控点对象ID', propname: 'DXID' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_sjbs__JKD_JKDDX_I', this.result, param)
    },
    searchSubmit(data) {
      this.load(data)
    },
    ...
    seeYjcl(data) {
      ...
      this.dialogContentComponent = () => import('@/components/datacom/dialog/sjgl-sjbs/JKD_JKDDX_I.vue')
    },
    seeYjclAdd() {
