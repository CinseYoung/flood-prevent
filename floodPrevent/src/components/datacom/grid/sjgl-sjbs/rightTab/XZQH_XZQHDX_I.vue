<template>
  <div>
    ...
    <div class="gr-datagrid">
      <div class="gr-tag">
        <span class="data-title">标识行政区划</span>
...
<script>
import search from '@/components/datacom/search/sjgl-sjbs/XZQH_XZQHDX_I.vue'
...
export default {
  data() {
    return {
      table_header: [
        { labelname: '行政区划对象ID', propname: 'DXID' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_sjbs__XZQH_XZQHDX_I', this.result, param)
    },
    searchSubmit(data) {
      this.load(data)
    },
    ...
    seeYjcl(data) {
      ...
      this.dialogContentComponent = () => import('@/components/datacom/dialog/sjgl-sjbs/XZQH_XZQHDX_I.vue')
    },
    seeYjclAdd() {
