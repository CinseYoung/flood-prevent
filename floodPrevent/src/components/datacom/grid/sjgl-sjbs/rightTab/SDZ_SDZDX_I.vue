<template>
  <div>
    ...
    <div class="gr-datagrid">
      <div class="gr-tag">
        <span class="data-title">水电站标识</span>
...
<script>
import search from '@/components/datacom/search/sjgl-sjbs/SDZ_SDZDX_I.vue'
...
export default {
  data() {
    return {
      table_header: [
        { labelname: '水电站对象ID', propname: 'DXID' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_sjbs__SDZ_SDZDX_I', this.result, param)
    },
    searchSubmit(data) {
      this.load(data)
    },
    ...
    seeYjcl(data) {
      ...
      this.dialogContentComponent = () => import('@/components/datacom/dialog/sjgl-sjbs/SDZ_SDZDX_I.vue')
    },
    seeYjclAdd() {
