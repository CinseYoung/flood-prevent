<template>
  <div>
    ...
    <div class="gr-datagrid">
      <div class="gr-tag">
        <span class="data-title">农村供水工程标识</span>
...
<script>
import search from '@/components/datacom/search/sjgl-sjbs/NCGS_NCGSDX_I.vue'
...
export default {
  data() {
    return {
      table_header: [
        { labelname: '农村供水工程对象ID', propname: 'DXID' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_sjbs__NCGS_NCGSDX_I', this.result, param)
    },
    searchSubmit(data) {
      this.load(data)
    },
    ...
    seeYjcl(data) {
      ...
      this.dialogContentComponent = () => import('@/components/datacom/dialog/sjgl-sjbs/NCGS_NCGSDX_I.vue')
    },
    seeYjclAdd() {
