...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '监控点对象ID', propname: 'JKDDXID' },
        { lablename: '设备编码', propname: 'SBBM' },
        { lablename: '设备名称', propname: 'SBMC' },
        { lablename: '通道编号', propname: 'TDBH' },
        { lablename: '设备型号', propname: 'SBXH' },
        { lablename: '详细位置', propname: 'XXWZ' },
        { lablename: '经度', propname: 'JD' },
        { lablename: '纬度', propname: 'WD' },
        { lablename: '建成日期', propname: 'JCRQ' },
        { lablename: '分配IP地址', propname: 'FPIPDZ' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_jkdjbsx', this.result, param)
    },
    result(data) {
