...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '禁采区名称', propname: 'JCQMC' },
        { lablename: '省界断面对象ID', propname: 'HDD_DXID' },
        { lablename: '年份', propname: 'NF' },
        { lablename: '禁采区名称', propname: 'JCQMC' },
        { lablename: '基本情况', propname: 'JBQK' },
        { lablename: '采砂点经度坐标', propname: 'CSDJDZB' },
        { lablename: '采砂点纬度坐标', propname: 'CSDWDZB' },
        { lablename: '图纸路径', propname: 'TZLJ' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_csjcqjbsx', this.result, param)
    },
    result(data) {
