...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '机构类别', propname: 'JGLB' },
        { lablename: '机构级别', propname: 'JGJB' },
        { lablename: '机构地址', propname: 'JGDZ' },
        { lablename: '邮编', propname: 'YB' },
        { lablename: '电话', propname: 'DH' },
        { lablename: '邮箱', propname: 'YX' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_dw_ffrzzjbxx', this.result, param)
    },
    result(data) {
