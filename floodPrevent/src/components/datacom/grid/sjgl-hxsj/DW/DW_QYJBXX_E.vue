...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '开业时间', propname: 'KYSJ' },
        { lablename: '企业营业状态', propname: 'QYYYZT' },
        { lablename: '单位负责人', propname: 'DWFZR' },
        { lablename: '法定代表人', propname: 'FDDBR' },
        { lablename: '国民经济行业代码', propname: 'GMJJXYDM' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_dw_qyjbxx', this.result, param)
    },
    result(data) {
