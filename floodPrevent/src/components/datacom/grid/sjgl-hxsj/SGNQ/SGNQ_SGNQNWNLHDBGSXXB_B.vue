...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '编制日期', propname: 'BZRQ' },
        { lablename: '发送日期', propname: 'FSRQ' },
        { lablename: '批复日期', propname: 'PFRQ' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_sgnq_sgnqnwnlhdbgsxxb', this.result, param)
    },
    result(data) {
