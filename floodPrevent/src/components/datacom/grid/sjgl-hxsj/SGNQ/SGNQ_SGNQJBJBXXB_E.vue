...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '水功能区界碑对象ID', propname: 'SGNQJBDXID' },
        { lablename: '水功能区界碑代码', propname: 'SGNQJBDM' },
        { lablename: '水功能区界碑名称', propname: 'SGNQJBMC' },
        { lablename: '上游水功能区对象ID', propname: 'SYSGNQDXID' },
        { lablename: '下游水功能区对象ID', propname: 'XYSGNQDXID' },
        { lablename: '立碑时间', propname: 'LBSJ' },
        { lablename: '立碑单位', propname: 'LBDW' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_sgnq_sgnqjbjbxxb', this.result, param)
    },
    result(data) {
