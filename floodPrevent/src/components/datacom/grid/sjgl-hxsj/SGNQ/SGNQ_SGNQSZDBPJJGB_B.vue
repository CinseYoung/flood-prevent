...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '达标情况', propname: 'DBQK' },
        { lablename: '营养状态指数', propname: 'YYZTZS' },
        { lablename: '超标项目与倍数', propname: 'CBXMYBS' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_sgnq_sgnqszdbjjgb', this.result, param)
    },
    result(data) {
