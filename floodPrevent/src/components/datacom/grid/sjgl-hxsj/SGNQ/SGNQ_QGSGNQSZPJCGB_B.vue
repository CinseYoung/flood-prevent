...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '所属批复规划', propname: 'SSPFGH' },
        { lablename: '代表断面名称', propname: 'DBDMMC' },
        { lablename: '全年监测次数', propname: 'QNJCCS' },
        { lablename: '监测项目个数及名称', propname: 'JCXMGSJMC' },
        { lablename: '全年水质类型', propname: 'QNSZLX' },
        { lablename: '汛期水质类型', propname: 'XQSZLX' },
        { lablename: '非汛期水质类型', propname: 'FXQSZLX' },
        { lablename: '全年达标与否', propname: 'QNDBYF' },
        { lablename: '全年达标评价超标项目', propname: 'QNDBPJCBXM' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_sgnq_qgsgnqszpjcgb', this.result, param)
    },
    result(data) {
