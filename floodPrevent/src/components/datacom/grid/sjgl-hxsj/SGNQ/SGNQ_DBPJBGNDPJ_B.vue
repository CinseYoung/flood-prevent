...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '个数达标比例', propname: 'GSDBBL' },
        { lablename: '评价河长', propname: 'PJHZ' },
        { lablename: '达标河长', propname: 'DBHZ' },
        { lablename: '河长达标比例', propname: 'HZDBBL' },
        { lablename: '评价面积', propname: 'PJMJ' },
        { lablename: '达标面积', propname: 'DBMJ' },
        { lablename: '面积达标率', propname: 'MJDBL' },
        { lablename: '评价蓄水量', propname: 'PJXSL' },
        { lablename: '达标蓄水量', propname: 'DBXSL' },
        { lablename: '蓄水量达标率', propname: 'XSLDBL' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_sgnq_dbpjbgndpj', this.result, param)
    },
    result(data) {
