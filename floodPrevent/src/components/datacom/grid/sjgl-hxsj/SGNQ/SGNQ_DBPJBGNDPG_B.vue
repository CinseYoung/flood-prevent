...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '评价年份', propname: 'PJNF' },
        { lablename: '评价因子', propname: 'PJYZ' },
        { lablename: '汛期水质类型', propname: 'XQSZLX' },
        { lablename: '非汛期水质类型', propname: 'FXQSZLX' },
        { lablename: '全年期水质类型', propname: 'QNQSZLX' },
        { lablename: '年评价次数', propname: 'NPJCS' },
        { lablename: '年达标次数', propname: 'NDBCS' },
        { lablename: '年达标率', propname: 'NDBL' },
        { lablename: '达标评价结论', propname: 'DBPJJL' },
        { lablename: '主要超标项目', propname: 'ZYCBXM' },
        { lablename: '营养状况评价结论', propname: 'YYZKPJJL' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_sgnq_dbpjbgndpg', this.result, param)
    },
    result(data) {
