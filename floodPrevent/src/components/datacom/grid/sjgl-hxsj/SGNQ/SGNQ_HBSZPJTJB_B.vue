...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '湖泊个数', propname: 'HBGS' },
        { lablename: '按个数比例', propname: 'AGSBL' },
        { lablename: '该水质水面面积', propname: 'GSZSMMJ' },
        { lablename: '按水面面积比例', propname: 'ASMMJBL' },
        { lablename: '营养状态类型', propname: 'YYZTLX' },
        { lablename: '营养状态下个数', propname: 'YYZTXGS' },
        { lablename: '营养状态下按个数比例', propname: 'YYZTXAGSBL' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_sgnq_hbszpjtjb', this.result, param)
    },
    result(data) {
