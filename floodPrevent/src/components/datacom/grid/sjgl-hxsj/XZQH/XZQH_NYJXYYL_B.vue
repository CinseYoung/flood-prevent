...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '农用大中型拖拉机', propname: 'NYDZXTLJ' },
        { lablename: '小型拖拉机', propname: 'XXTLJ' },
        { lablename: '大中型拖拉机机引农具', propname: 'DZXTLJJYNJ' },
        { lablename: '小型拖拉机机引农具', propname: 'XXTLJJYNJ' },
        { lablename: '农用排灌柴油机', propname: 'NYPGCYJ' },
        { lablename: '渔用机动船', propname: 'YYJDC' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_xzqh_nyjxyyl', this.result, param)
    },
    result(data) {
