...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '变更时间', propname: 'BGSJ' },
        { lablename: '变更类型', propname: 'BGLX' },
        { lablename: '变更后行政区划对象ID', propname: 'BGHXZQHDXID' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_xzqh_bgls', this.result, param)
    },
    result(data) {
