...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '谷物总产量', propname: 'GWZCL' },
        { lablename: '稻谷产量', propname: 'DGCL' },
        { lablename: '小麦产量', propname: 'XMCL' },
        { lablename: '玉米产量', propname: 'YMCL' },
        { lablename: '豆类产量', propname: 'DLCL' },
        { lablename: '薯类产量', propname: 'SLCL' },
        { lablename: '油料总产量', propname: 'YLZCL' },
        { lablename: '油菜籽产量', propname: 'YCZCL' },
        { lablename: '花生产量', propname: 'HSCL' },
        { lablename: '芝麻类产量', propname: 'ZMLCL' },
        { lablename: '棉花产量', propname: 'MHCL' },
        { lablename: '麻类产量', propname: 'MLCL' },
        { lablename: '甘蔗产量', propname: 'GZCL' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_xzqh_nzqclqk', this.result, param)
    },
    result(data) {
