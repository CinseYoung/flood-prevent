...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '水资源分区对象ID', propname: 'SZY_DXID' },
        { lablename: '水土保持区划对象ID', propname: 'STB_DXID' },
        { lablename: '行政区划代码', propname: 'XZQHDM' },
        { lablename: '代码级别', propname: 'DMJB' },
        { lablename: '行政区划名称', propname: 'XZQHMC' },
        { lablename: '上级代码', propname: 'SJDM' },
        { lablename: '是否叶子结点', propname: 'SFYZJD' },
        { lablename: '开始时间', propname: 'KSSJ' },
        { lablename: '截止时间', propname: 'JZSJ' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_xzqh_xzqhjbxx', this.result, param)
    },
    result(data) {
