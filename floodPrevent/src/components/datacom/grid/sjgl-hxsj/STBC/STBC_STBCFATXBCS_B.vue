...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '工程措施', propname: 'GCCS' },
        { lablename: '工程措施投资', propname: 'GCCSTZ' },
        { lablename: '临时措施', propname: 'LSCS' },
        { lablename: '临时措施投资', propname: 'LSCSTZ' },
        { lablename: '植物措施', propname: 'ZWCS' },
        { lablename: '分区', propname: 'FQ' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_stbcfatxbcs', this.result, param)
    },
    result(data) {
