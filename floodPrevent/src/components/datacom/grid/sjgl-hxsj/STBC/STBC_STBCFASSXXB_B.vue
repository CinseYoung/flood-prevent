...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '施工单位', propname: 'SGDW' },
        { lablename: '施工负责人', propname: 'SGFZR' },
        { lablename: '监理单位名称', propname: 'JLDWMC' },
        { lablename: '监理负责人', propname: 'JLFZR' },
        { lablename: '监测单位名称', propname: 'JCDWMC' },
        { lablename: '监测负责人', propname: 'JCFZR' },
        { lablename: '方案总工期开始时间', propname: 'FAZGQKSSJ' },
        { lablename: '方案总工期结束时间', propname: 'FAZGQJSSJ' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_stbcfassxxb', this.result, param)
    },
    result(data) {
