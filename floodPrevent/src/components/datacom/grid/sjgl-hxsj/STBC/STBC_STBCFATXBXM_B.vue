...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '建设长度', propname: 'JSZD' },
        { lablename: '建设面积', propname: 'JSMJ' },
        { lablename: '建设区域', propname: 'JSQY' },
        { lablename: '填方量', propname: 'TFL' },
        { lablename: '挖方量', propname: 'WFL' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_stbcfatxbxm', this.result, param)
    },
    result(data) {
