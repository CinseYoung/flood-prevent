...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '批复文号', propname: 'PFWH' },
        { lablename: '批复结果', propname: 'PFJG' },
        { lablename: '批复时间', propname: 'PFSJ' },
        { lablename: '请示文号', propname: 'QSWH' },
        { lablename: '送达时间', propname: 'SDSJ' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_stbcfapfxxb', this.result, param)
    },
    result(data) {
