...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '技术审查得分', propname: 'JSSCDF' },
        { lablename: '审查结果', propname: 'SCJG' },
        { lablename: '审查时间', propname: 'SCSJ' },
        { lablename: '审查地点', propname: 'SCDD' },
        { lablename: '审查主持人', propname: 'SCZCR' },
        { lablename: '审查专家组组长', propname: 'SCZJZZZ' },
        { lablename: '审查意见文号', propname: 'SCYJWH' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_stbcfajsscxxb', this.result, param)
    },
    result(data) {
