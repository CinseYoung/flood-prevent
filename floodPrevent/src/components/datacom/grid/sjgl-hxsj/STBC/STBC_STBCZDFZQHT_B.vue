...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '空间对象周长', propname: 'KJDXZZ' },
        { lablename: '空间对象面积', propname: 'KJDXMJ' },
        { lablename: '重点防治区名称', propname: 'ZDFZQMC' },
        { lablename: '重点防治区类型', propname: 'ZDFZQLX' },
        { lablename: '重点防治区级别', propname: 'ZDFZQJB' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_stbczdfzqht', this.result, param)
    },
    result(data) {
