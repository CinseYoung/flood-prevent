...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '身份证号', propname: 'SFZH' },
        { lablename: '所属工作阶段', propname: 'SSGZJD' },
        { lablename: '姓名', propname: 'XM' },
        { lablename: '性别', propname: 'XB' },
        { lablename: '岀生日期', propname: 'CSRQ' },
        { lablename: '民族', propname: 'MZ' },
        { lablename: '是否销号', propname: 'SFXH' },
        { lablename: '销号时间', propname: 'XHSJ' },
        { lablename: '销号原因', propname: 'XHYY' },
        { lablename: '所属专业大类', propname: 'SSZYDL' },
        { lablename: '行政区划对象ID', propname: 'XZQHDXID' },
        { lablename: '单位对象ID', propname: 'DXID' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_zrr_zrrjbsx', this.result, param)
    },
    result(data) {
