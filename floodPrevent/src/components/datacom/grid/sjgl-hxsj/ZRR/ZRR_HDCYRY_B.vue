...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '年龄', propname: 'NL' },
        { lablename: '地址', propname: 'DZ' },
        { lablename: '联系方式', propname: 'LXFS' },
        { lablename: '从事工作', propname: 'CSGZ' },
        { lablename: '资质', propname: 'ZZ' },
        { lablename: '培训效果', propname: 'PXXG' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_zrr_hdcyry', this.result, param)
    },
    result(data) {
