...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '计算分区内测站评价河长', propname: 'JSFQNCZPJHZ' },
        { lablename: '计算分区内测站评价而积', propname: 'JSFQNCZPJMJ' },
        { lablename: '计算分区内测站评价库容', propname: 'JSFQNCZPJKR' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_szy_szyjsfqyczgxb', this.result, param)
    },
    result(data) {
