...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '水资源公报代码', propname: 'SZYGBDM' },
        ...
        { lablename: '评价河长', propname: 'DBHZ' },
        { lablename: '达标河长', propname: 'DBHZ' },
        { lablename: '评价湖泊面积', propname: 'PJHBMJ' },
        { lablename: '达标湖泊面积', propname: 'DJBHBMJ' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_szy_zyjhhbsgnqszd', this.result, param)
    },
    result(data) {
