...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '水资源论证通过可开采水量', propname: 'SZYLZTGKKCSL' },
        { lablename: '当年新批申请 数', propname: 'DNXPSQS' },
        ...
        { lablename: '年终保有的有效取水许可证地表水许可水 量', propname: 'NZBYDYXQSXKZDBSXKSL' },
        { lablename: '年终保有的有效取水许可证地下水许可水 量', propname: 'NZBYDYXQSXKZDXSXKSL' },
        { lablename: '年终保有的有效取水许可证地热水许可水 量', propname: 'NZBYDYXQSXKZDRSXKSL' },
        { lablename: '年终保有的有效取水许可证矿泉水许可水 量', propname: 'NZBYDYXQSXKZKQSXKSL' },
        { lablename: '年终保有的有效取水许可证水力发电许可 水量', propname: 'NZBYDYXQSXKZSLFDXKSL' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_szy_qsxkjbqkb', this.result, param)
    },
    result(data) {
