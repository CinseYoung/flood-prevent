...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '水资源计算分区代码', propname: 'SZYJSFQDM' },
        { lablename: '水资源计算分区名称', propname: 'SZYJSFQMC' },
        { lablename: '水资源一级区对象ID', propname: 'SZYYJQDXID' },
        { lablename: '水资源二级区对象ID', propname: 'SZYEJQDXID' },
        { lablename: '水资源三级区对象ID', propname: 'SZYSJQDXID' },
        { lablename: '水资源计算分区面积', propname: 'SZYJSFQMJ' },
        { lablename: '水资源计算分区平原面积', propname: 'SZYJSFQPYMJ' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_szy_szyjsfqjbxxb', this.result, param)
    },
    result(data) {
