...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '评价吋间', propname: 'PJSJ' },
        { lablename: '评价时段长', propname: 'PJSDZ' },
        { lablename: '评价方法', propname: 'PJFF' },
        { lablename: '水资源分区测站总数', propname: 'SZYFQCZZS' },
        { lablename: '水资源分区达标测站个数', propname: 'SZYFQDBCZGS' },
        { lablename: '水资源分区总评价河长', propname: 'SZYFQZPJHZ' },
        { lablename: '水资源分区达标河长', propname: 'SZYFQDBHZ' },
        { lablename: '水资源分区总评价面积', propname: 'SZYFQZPJMJ' },
        { lablename: '水资源分区达标面积', propname: 'SZYFQDBMJ' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_szy_szyfqpjjgb', this.result, param)
    },
    result(data) {
