...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '水功能区纳污能力核定报告书代码', propname: 'SGNQNWNLHDBGSDM' },
        { lablename: '水资源分区对象ID', propname: 'SZYFQDXID' },
        { lablename: '水质监测项目类型', propname: 'SZJCXMLX' },
        { lablename: '现状入河量', propname: 'XZRHL' },
        { lablename: '现状纳污能力', propname: 'XZNWNL' },
        { lablename: '2020年规划纳污能力', propname: 'GHNWNL2020' },
        { lablename: '2030年规划纳污能力', propname: 'GHNWNL2030' },
        { lablename: '2015限制排污总里', propname: 'XZPWZL2015' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_szy_nwnljxppwzlkzf', this.result, param)
    },
    result(data) {
