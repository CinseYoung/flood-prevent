...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '水功能区纳污能力核定报告书代码', propname: 'SGNQNWNLIIDBGSDM' },
        { lablename: '水资源分区对象ID', propname: 'SZYFQDXID' },
        { lablename: '一级水功能区个数', propname: 'YJSGNQGS' },
        { lablename: '二级水功能区个数', propname: 'EJSGNQGS' },
        { lablename: '基准年水质达标率', propname: 'JZNSZDBL' },
        { lablename: '2015年水质达标率', propname: 'SZDBL2015' },
        { lablename: '2030年水质达标 率', propname: 'SZDBL2030' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_szy_nwnljxppwzlkzj', this.result, param)
    },
    result(data) {
