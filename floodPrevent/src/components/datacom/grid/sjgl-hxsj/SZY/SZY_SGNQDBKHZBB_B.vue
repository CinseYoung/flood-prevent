...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '水功能区考核个数', propname: 'SGNQKHGS' },
        { lablename: '水功能区要求达标个数', propname: 'SGNQYQDBGS' },
        { lablename: '水功能区要求达标长度', propname: 'SGNQYQDBZD' },
        { lablename: '水功能区要求达标面积', propname: 'SGNQYQDBMJ' },
        { lablename: '行政区界断面考核个数', propname: 'XZQJDMKHGS' },
        { lablename: '行政区界断面要求达标个数', propname: 'XZQIDMYQDBGS' },
        { lablename: '水资源管理监督目标与工作计划代码', propname: 'SZYGLJDMBYGZJHDM' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_szy_sgnqdbkhzbb', this.result, param)
    },
    result(data) {
