...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '水资源分区面积', propname: 'SZYFQMJ' },
        { lablename: '山丘区面积', propname: 'SQQMJ' },
        { lablename: '平原区面积', propname: 'PYQMJ' },
        { lablename: '多年平均降水量', propname: 'DNPJJSL' },
        { lablename: '多年平均水资源总量', propname: 'DNPJSZYZL' },
        { lablename: '多年平均地表水资源量', propname: 'DNPJDBSZYL' },
        { lablename: '多年平均地下水 资源量', propname: 'DNPJDXSZYL' },
        { lablename: '多年平均地表水和地下水资源重复计算量', propname: 'DNPJDBSHDXSZYZFJSL' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_szy_szyfqjbsx', this.result, param)
    },
    result(data) {
