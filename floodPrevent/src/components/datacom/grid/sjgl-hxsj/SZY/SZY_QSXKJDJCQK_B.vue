...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '年终保有实施监 督管理的取水许 可证数', propname: 'NZBYSSJDGLDQSXKZS' },
        { lablename: '取水许可证批准 的水量', propname: 'QSXKZPZDSL' },
        { lablename: '年审取水许可证 数', propname: 'NSQSXICZS' },
        { lablename: '年审水量', propname: 'NSSL' },
        { lablename: '退水水质检测的 取水户数', propname: 'TSSZJCDQSHS' },
        { lablename: '退水水质检测达 标率', propname: 'TSSZJCDBL' },
        { lablename: '吊销许可证数', propname: 'DXXKZS' },
        { lablename: '吊销许可证削减许可水量', propname: 'DXXTCZXJXKSL' },
        ...
        { lablename: '水平衡测试企业 数', propname: 'SPHCSQYS' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_szy_qsxkjdjcqk', this.result, param)
    },
    result(data) {
