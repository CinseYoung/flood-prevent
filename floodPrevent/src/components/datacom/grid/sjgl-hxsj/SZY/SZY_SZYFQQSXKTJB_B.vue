...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '当年新发许可证', propname: 'DNXFXKZS' },
        ...
        { lablename: '年终保有的有效取水许可证地下水许可水量', propname: 'NZBYDYXQSXKZDXSXKSL' },
        { lablename: '年终保有的有效取水许可证地热水许可水量', propname: 'NZBYDYXQSXKZDRSXKSL' },
        { lablename: '年终保有的有效取水许可证矿泉水许可水量', propname: 'NZBYDYXQSXKZKQSXKSL' },
        { lablename: '年终保有的有效取水许可证水力发电许可水量', propname: 'NZBYDYXQSXKZSLFDXKSL' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_szy_szyfqqsxktjb', this.result, param)
    },
    result(data) {
