...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '水功能区类别代码', propname: 'SGNQLBDM' },
        { lablename: '水功能区水质达标率', propname: 'SGNQSZDBL' },
        { lablename: '是否达标', propname: 'SFDB' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_szy_xzqsgnqfldbkhqkb', this.result, param)
    },
    result(data) {
