...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '多媒体对象ID2', propname: 'DXID' },
        ...
        { lablename: '环比水位变幅', propname: 'HBSWBF' },
        { lablename: '环比蓄变量', propname: 'HBXBL' },
        { lablename: '时段1埋深', propname: 'SD1MS' },
        { lablename: '时段1水位', propname: 'SD1SW' },
        { lablename: '时段2埋深', propname: 'SD2MS' },
        { lablename: '时段2水位', propname: 'SD2SW' },
        { lablename: '时段3埋深', propname: 'SD3MS' },
        { lablename: '时段3水位', propname: 'SD3SW' },
        { lablename: '同比水位变幅', propname: 'TBSWBF' },
        { lablename: '同比蓄变量', propname: 'TBXBL' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_sydx_dxjgqdxs', this.result, param)
    },
    result(data) {
