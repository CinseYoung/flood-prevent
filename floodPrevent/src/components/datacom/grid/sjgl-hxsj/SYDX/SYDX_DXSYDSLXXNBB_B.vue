...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '地下水资源量', propname: 'DXSZYL' },
        { lablename: '环境地质问题', propname: 'HJDZWT' },
        { lablename: '开采井数', propname: 'KCJS' },
        { lablename: '可开采量', propname: 'KKCL' },
        { lablename: '水源地面积', propname: 'SYDMJ' },
        { lablename: '超采量', propname: 'CCL' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_sydx_dxsydslxxnbb', this.result, param)
    },
    result(data) {
