...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '月份', propname: 'YF' },
        { lablename: '计划取水类型', propname: 'JHQSLX' },
        { lablename: '计划取水量', propname: 'JHQSL' },
        { lablename: '实际取水类型', propname: 'SJQSLX' },
        { lablename: '实际取水量', propname: 'SJQSL' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_sydx_dxssydfxxcltjb', this.result, param)
    },
    result(data) {
