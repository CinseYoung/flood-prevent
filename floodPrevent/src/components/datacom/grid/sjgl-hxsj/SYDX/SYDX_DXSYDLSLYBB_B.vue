...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '旬别', propname: 'XB' },
        { lablename: '月份', propname: 'YF' },
        { lablename: '地下水埋深', propname: 'DXSMS' },
        { lablename: '可开采量', propname: 'KKCL' },
        { lablename: '平均水位', propname: 'PJSWEI' },
        { lablename: '平均水温', propname: 'PJSWEN' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_sydx_dxsydlslybb', this.result, param)
    },
    result(data) {
