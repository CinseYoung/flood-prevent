...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '时间', propname: 'SJ' },
        { lablename: '评价方法', propname: 'PJFF' },
        { lablename: '代表水温', propname: 'DBSWEN' },
        { lablename: '代表水位', propname: 'DBSWEI' },
        { lablename: '代表埋深', propname: 'DBMS' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_sydx_dxssyddbswxxb', this.result, param)
    },
    result(data) {
