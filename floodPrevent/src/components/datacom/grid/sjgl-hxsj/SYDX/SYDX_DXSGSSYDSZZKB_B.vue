...
export default {
  data() {
    return {
      table_header: [
        ...
        { lablename: '地下水通报代码', propname: 'DXSTBDM' },
        { lablename: '序号', propname: 'XH' },
        { lablename: '地下水水源地对象ID', propname: 'DXSSYDDXID' },
        { lablename: '水源地取水用途', propname: 'SYDQSYT' },
        { lablename: '水质总体评价', propname: 'SZZTPJ' },
        { lablename: '取样时间', propname: 'QYSJ' },
        { lablename: '浓度', propname: 'ND' },
        { lablename: '超标项冃', propname: 'CBXM' },
        { lablename: '超标率', propname: 'CBL' },
        { lablename: '吋间戳', propname: 'SJC' },
        { lablename: '创建时间', propname: 'CJSJ' },
        { lablename: '最后更新时冋', propname: 'ZHGXSJ' },
  ...
  methods: {
    load(param) {
      this.api.get(this, 'data_sjgl_dxsy_dxsgssydszzkb', this.result, param)
    },
    result(data) {
