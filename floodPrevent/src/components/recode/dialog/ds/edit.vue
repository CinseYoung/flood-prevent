<template>
  ...
  >
    ...
    <el-form-item label="档案室管理员" prop="manager">
    ...
    <el-form-item label="可存放文档总数" prop="total">
      <el-input v-model="dataForm.total" style="width:200px"></el-input>
    </el-form-item>
    <el-form-item label="当前存在文档数" prop="current_total">
  ...
  methods: {
    submitForm(that) {
      this.$refs.dataForm.validate(valid => {
        ...
        this.api.post(this, 'record_room_update', (data) => {
          this.$message({
            type: 'success',
            message: '修改成功!'
          })
