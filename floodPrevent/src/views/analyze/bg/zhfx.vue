  ...
  <div style="height:100%;">
    ...
    <div class="gr-datagrid">
      <div class="gr-tag bg-width">
        <span class="data-title">水情综合分析</span>
...
<script>
import search from '@/components/analyze/search/bg-zhfx/index.vue'
export default {
  data() {
    return {
      time: '',
  ...
  components: { 'dz-search': search },
  created() {
    this.$emit('update:menuName', '水情综合分析')
  },
  methods: {
    searchSubmit(data) {
