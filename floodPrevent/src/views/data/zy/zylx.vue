<template>
  <div style="height:100%;">
    ...
    <div class="gr-datagrid">
       <div class="gr-tag">
        <span class="data-title">资源类型</span>
...
<script>
import datagrid from '@/components/datacom/grid/zylx/index.vue'
import search from '@/components/datacom/search/zylx/index.vue'
...
export default {
  ...
  created() {
    this.$emit('update:menuName', '资源类型')
  },
  methods: {
    // searchSubmit(data) {
    ...
    seeYjcl(data) {
      ...
      this.dialogContentComponent = () => import('@/components/datacom/dialog/zy-zylx/index.vue')
    },
    seeYjclAdd() {
