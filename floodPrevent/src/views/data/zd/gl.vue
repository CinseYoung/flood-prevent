<template>
  <div style="height:100%;">
    <div class="gr-datagrid">
       <div class="gr-tag">
        <span class="data-title">字典类型管理</span>
...
<script>
import datagrid from '@/components/datacom/grid/zd-zdlx/index.vue'
import search from '@/components/datacom/search/zd-zdlx/index.vue'
...
export default {
  ...
  created() {
    this.$emit('update:menuName', '字典类型管理')
  },
  methods: {
    seeYjcl(data) {
      ...
      this.dialogContentComponent = () => import('@/components/datacom/dialog/zd-zdlx/index.vue')
    },
    seeYjclAdd() {
