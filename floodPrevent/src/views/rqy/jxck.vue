<template>
  <div style="height:100%">
    <div class="gr-datagrid-notitle">
      <div class="gr-tag">
        <span class="data-title">镜像仓库</span>
        <el-button type="primary" size="mini" @click="createServer">创建仓库</el-button>
      </div>
...
<script>
import dataGrid from '@/components/system/grid/rqy-jx/index.vue'
...
export default {
  ...
  methods: {
    ...
    createServer(data) {
      ...
      this.dialogContentComponent = () =>
        import('@/components/system/dialog/rqy-jxck/create.vue')
    }
  },
  components: {
    dataGrid,
  ...
  created() {
    this.$emit('update:menuName', '镜像仓库')
  }
}
</script>
<style>
